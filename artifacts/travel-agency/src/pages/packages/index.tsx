...
export default function PackagesPage() {
  ...
  const form = useForm<PackageFormValues>({
    ...
    defaultValues: {
      name: "", destinationId: 0, durationDays: 7, pricePerPerson: 0,
      description: "", includes: "", imageUrl: "", isActive: true
    }
  });
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <Dialog open={isAddOpen} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
              <Button data-testid="button-add-package"><Plus className="ml-2 h-4 w-4" /> إضافة باقة</Button>
            </DialogTrigger>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <FormField control={form.control} name="imageUrl" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input {...field} placeholder="https://..." data-testid="input-package-image" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="includes" render={({ field }) => (
                      <FormItem className="col-span-2">
                        ...
                        <FormControl><Textarea {...field} data-testid="input-package-includes" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  </div>
                  <DialogFooter>
                    <Button type="submit" disabled={createPackage.isPending || updatePackage.isPending} data-testid="button-submit-package">
                      {editingPackage ? "حفظ التغييرات" : "إنشاء الباقة"}
                    </Button>
                  </DialogFooter>
                </form>
              </Form>
